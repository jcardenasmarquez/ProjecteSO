...
//Funció per treure els numeros de la baralla de cartes
...
//-----FUNCIONS PER LES CONSULTES--------

//CONSULTA 1: LLSITA DE JUGADORS AMB QUI HE JUGAT ALGUNA PARTIDA
...
//CONSULTA 2: RESULTATS (GUANYADOR) DE LES PARTIDES QUE HE JUGAT AMB EL JUGADOR2
...
//CONSULTA 3: LLISTA DE PARTIDES JUGADES ENTRE FECCHA I FECHA2
...
void ConnMYSQL (MYSQL *conn)
{
	...
	conn = mysql_real_connect (conn, "shiva2.upc.es","root", "mysql", "TG6BBDD1", 0, NULL, 0);
	if (conn==NULL) {
...
//BUSCA EL JUGADOR I COMPROVA QUE ESTIGUI REGISTRAT, QUE LA CONTRASENYA SIGUI CORRECTE, ETC. PER A FER EL LOGIN
...
//AFEGEIX UN COMPTE QUE ES VOL REGISTRAR A LA BASE DE DADES
...
//ESBORRA UN COMPTE DE LA BASE DE DADES
...
//------------
//ELIMINA UN JUGADOR DE LA TAULA DE PARTIDES, POSA -1 A SOCKET I USUARI
...
//AFEGEIX UN USUARI A LA LLISTA DE CONNECTATS (RETORNA 1 SI HO FA, 0 SI ESTÀ PLENA)
...
//RETORNA EL SOCKET DE L'USUARI O -1 SI NO EL TROBA
...
//RETORNA EL NOM DE L'USUARI AMB SOCKET socket
...
//DONA LA POSICIO A LA LLISTA D'UN USUARI
...
//ELIMINA DE LA LLISTA DE CONNECTATS A UN USUARI 
...
//RETORNA UN VECTOR CHAR AMB ELS NOMS DELS USUARIS CONNECTATS SEPARATS PER COMES
...
//---------------------
//AFEGEIX UNA PARTIDA A LA TAULA DE PARTIDES EN EL PRIMER BUIT QUE TROBA
...
//JUGADA D'ATAC: BUSCA A LA BBDD EL VALOR DE LA CARTA I LI RESTA LA VIDA AL JUGADOR ATACAT. RETORNA LA VIDA AMB QUÈ ES QUEDA
...
//JUGADA DEFENSA: FA EL MATEIX QUE LA JUGADA D'ATAC PERÒ SUMANT EL VALOR DE LA CARTA
...
void *AtenderCliente(void *socket) //recibimos por referencia y no sabemos que es un int
{
	...
	while (terminar ==0)
	{
		...
		char msgtocl[512]; //Missatge que envia al client
		
		//MISSATGES (ARRIBADA-TORNADA)
		/*
		CODI 0		DESCONNEXIÓ
		CODI 1		CONSULTA 1
		CODI 2		CONSULTA 2
		CODI 3		CONSULTA 3
		CODI 4		COMPROVAR VALIDESA USUARI I CONTRASENYA (CONECTAR)
		CODI 5		REGISTAR USUARI
		CODI 6		AFEGIR A LA LLISTA DE CONNECTATS
		CODI 8		--CONTROL CLASSE
		CODI 9		ELIMINA COMPTE
		CODI 10		AFEGIR PARTIDA
		CODI 11		JUGADOR ACCEPTA INVITACIÓ
		CODI 12		JUGADOR REBUTJA INVITACIÓ
		CODI 13		RETORNA EL NUMERO DE PERSONES QUE HAN ACCEPTAT
		CODI 14		CREA LA BARALLA DE CARTES (NUMEROS ALEATORIS)
		CODI 15		PASSA DE TORN
		CODI 16		JUGADA DE DEFENSA
		CODI 17		JUGADA D'ATAC
		CODI 18		ENVIA EL NOM DE LA PERSONA QUE MOR A TOTS
		CODI 20		XAT
		**/
